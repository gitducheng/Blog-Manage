...
export default function Dynamic({ className }: { className?: string }) {
  ...
  return (
    <div
      className={`flex justify-between items-center w-full px-4 py-3 border dark:border-transparent rounded-lg bg-white dark:bg-black-b mb-2 ${className}`}
    >
      ...
      <Link
        href="/record"
        className={`flex-1 line-clamp-1 hover:text-primary cursor-pointer ${
