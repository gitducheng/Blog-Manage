                        ...
                        <div className="ml-2 sm:ml-6">
                          <div className="flex items-center space-x-4">
                            <div className="text-2xl text-gray-600 dark:text-primary">
                              {month}月{" "}
                              {item.month[+month].wordCount / 1000 > 10 && "🔥"}
                            </div>
                            <div>{item.month[+month].total} 篇文章</div>
                            <div>
                              {(item.month[+month].wordCount / 1000).toFixed(2)}{" "}
                              K字
                            </div>
                          </div>

                          {item.month[+month].list.map(
                            (article: Article, index) => (
                              ...
                              >
                                <Link
                                  ...
                                  target="_blank"
                                  className="dark:text-[#bfbfbf] group-hover:text-primary  "
                                >
