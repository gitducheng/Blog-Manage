...
const CommentList = forwardRef(({ id, reply }: Props, ref) => {
  const [data, setData] = useState<Paginate<Comment[]>>(
    {} as Paginate<Comment[]>
  );
    ...
    <div className="CommentListComponent">
              ...
              <li className="item" key={one.id}>
                <div className="comment_user_one">
                  ...
                  <div className="comment_user_one_info">
                    ...
                    <span className="time">
                      {dayjs(+one.createTime).format("YYYY-MM-DD HH:mm")}
                    </span>
                  </div>
                ...
                {one?.children?.length
                  ? one.children?.map((two) => (
                      <div
                        className="comment_user_two !ml-5 sm:!ml-12"
                        key={two.id}
                      >
                        <div className="comment_user_two_info">
                          ...
                          {two.url ? (
                            <a
                              href={two.url}
                              className="name active !text-primary"
                              target="_blank"
                              rel="noopener noreferrer"
                            >
                              {two.name}
                          ...
                          <span className="time">
                            {dayjs(+two.createTime).format("YYYY-MM-DD HH:mm")}
                          </span>
                          <div
                            className="reply"
                            ...
                            <div className="comment_user_three !ml-5 sm:!ml-12">
                              <div className="comment_user_three_info">
                                ...
                                <div
                                  className="reply"
                                  onClick={() =>
                                    replyComment(three.id!, three.name)
                                  }
                                >
                                  <RiMessage3Line />
                                </div>
                            ...
                            {three.children?.map((four) => (
                              <div key={four.id}>
                                <div className="comment_user_three !ml-5 sm:!ml-12">
                                  <div className="comment_user_three_info">
                                    ...
                                    <div
                                      className="reply"
                                      onClick={() =>
                                        replyComment(four.id!, four.name)
                                      }
                                    >
                                      <RiMessage3Line />
                                    </div>
                                ...
                                {four.children?.map((five) => (
                                  <div
                                    key={five.id}
                                    className="comment_user_three !ml-5 sm:!ml-12"
                                  >
                                    <div className="comment_user_three_info">
                                      {five.avatar ? (
                                        <img
                                      ...
                                      <div
                                        className="reply"
                                        onClick={() =>
                                          replyComment(five.id!, five.name)
                                        }
                                      >
                                        <RiMessage3Line />
                                      </div>
      ...
      {!data?.result?.length ? (
        ...
        <Pagination
          ...
          classNames={{
            item: "shadow-none bg-transparent dark:hover:!bg-black-b  ",
            prev: "dark:bg-black-b  ",
            next: "dark:bg-black-b  ",
          }}
        />
      )}
    </div>
