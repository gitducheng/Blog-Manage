...
docker run -d \
 --name thrivex-mysql \ # 容器名称
-p 3306:3306 \
 -e MYSQL_ROOT_PASSWORD=<your_password> \
 -e MYSQL_DATABASE=thrivex \ # 数据库名称
-v mysql-data:/var/lib/mysql \
 mysql:8.0

docker exec -i thrivex-mysql mysql -uroot -p<your_password> thrivex < /Users/bytedance/Desktop/oldcode/github/ThriveX-Server/ThriveX.sql
